...
public class TLTR extends StructPack4 {
     ...
     * {@link en_LTR_CC_ChNum}. Указывает, является ли данное соединение управляющим
     ...
     * {@link en_LTR_CC_Iface} и {@link en_LTR_CC_Flags} для указания дополнительных параметров
     * соединения.
     */
    public WORD cc = new WORD();
    /**
     * Флаги состояния соединения. Объединенный через логическое ИЛИ набор
     * значений из {@link en_LTR_ChStateFlags}.
